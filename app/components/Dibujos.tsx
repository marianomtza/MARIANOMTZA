                ...
                >
                  ...
                  <div className="space-y-5">
                    <div className="flex flex-wrap items-center gap-2.5">
                      <div className="text-[10px] font-mono tracking-[2px] text-white/50">
                        PINCELES
                      </div>
                      <div className="text-[10px] font-mono tracking-[2px] text-white/30">
                        {strokeCount} TRAZOS
                      </div>
                    </div>

                    <div className="flex flex-wrap items-center gap-2 bg-zinc-950 rounded-2xl p-1.5 border border-white/10">
                      {TOOLS.map((tool) => (
                        <button
                          key={tool.id}
                          onClick={() => setCurrentTool(tool.id)}
                          className={`px-4 py-2.5 text-[11px] tracking-[1.2px] font-medium rounded-xl transition-all flex items-center gap-2 ${
                            currentTool === tool.id
                    ...
                    <div className="flex flex-wrap items-center gap-5">
                      <div>
                        <div className="text-[10px] font-mono tracking-[2px] text-white/50 mb-2">
                          BARRA DE COLORES
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          <label
                            className="ml-1 flex items-center gap-2 rounded-full border border-white/20 px-3 py-1.5 text-[10px] font-mono tracking-[1.5px] text-white/70"
                          ...
                          >
                            ...
                            <input
                              ...
                              className="h-5 w-5 rounded-full bg-transparent cursor-pointer"
                            />
                          </label>
                        </div>
                      </div>
                      ...
                      <div className="flex-1 min-w-[220px] space-y-3">
                        <div>
                          <div className="flex items-center justify-between text-[10px] font-mono tracking-[2px] text-white/50 mb-1.5">
                            <span>GROSOR</span>
                            <span>{Math.round(brushSize * 10) / 10}px</span>
                          </div>
                          <input
                            type="range"
                            min={1}
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full accent-[#9b5fd6] disabled:opacity-40"
                          />
                        </div>
                      </div>
                    </div>

                    <div className="flex flex-wrap items-center gap-2 text-xs font-mono tracking-widest">
                      <button
                        onClick={undo}
                        disabled={!canUndo}
                        className="px-4 py-2 border border-white/20 hover:border-[#9b5fd6] hover:text-[#9b5fd6] rounded-full transition flex items-center gap-1.5 disabled:opacity-30 disabled:hover:border-white/20 disabled:hover:text-white"
                      >
                        ↩ DESHACER
                      </button>
                      <button
                      ...
                      <button
                        ...
                        className="px-4 py-2 border border-white/20 hover:border-emerald-400 hover:text-emerald-400 rounded-full transition disabled:opacity-30"
                      >
                        DESCARGAR PNG
                      </button>
                    </div>

                    <div className="text-[10px] font-mono tracking-[1.5px] text-white/35">
                      TIP: rueda del mouse o trackpad para navegar, y usa trazos cortos para mayor
                      precisión.
                    </div>
                  </div>
